...
public class Dashboard extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            this.getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new HomeView()).commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.donateinfo) {
            this.getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new BloodInfo()).commit();
        }
        if (id == R.id.devinfo) {
            this.getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new AboutUs()).commit();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == home) {
            ...
            this.getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new AchievmentsView()).commit();
            ...
            this.getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new SearchDonorFragment()).commit();

        } else if (id == R.id.nearby_hospital) {
            this.getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new NearByHospitalActivity()).commit();
